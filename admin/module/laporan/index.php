						...
						<tbody>
							...
							<?php 
								...
								foreach($hasil as $isi){ 
									$total += $isi['total'];
									$modal_per_baris = $isi['harga_beli'] * $isi['jumlah'];
							...
							<tr>
								...
								<th>Rp.<?php echo number_format($modal_per_baris);?>,-</th>
						...
						<tfoot>
							<tr>
								...
								<th>Rp.<?php echo number_format($total);?>,-</th>
									<th style="background:#0bb365;color:#fff;">Total Pemasukan Sebelum / Sesudah Diskon</th>
									<th style="background:#0bb365;color:#fff;">Rp.<?php echo number_format($total_akhir);?>,-</th>
