...
<tbody>
    ...
    <tr style="font-weight:bold; background-color:#f2f2f2;">
        ...
        <td colspan="1" style="background:#0bb365;color:#fff;">Total Pemasukan Sebelum / Sesudah Diskon</td>
        <td style="background:#0bb365;color:#fff;">Rp.<?= number_format($total_akhir); ?>,-</td>
